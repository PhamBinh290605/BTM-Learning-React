...
const values = [
  {
    ...
    description:
      "Nội dung được xây dựng từ nhu cầu công việc thực tế và cập nhật liên tục theo thị trường.",
    icon: "01",
  },
  {
    title: "Lấy người học làm trung tâm",
    description:
      "Mỗi khóa học đều tối ưu trải nghiệm học từ cơ bản đến nâng cao để ai cũng có thể theo kịp.",
    icon: "02",
  },
  {
    title: "Cộng đồng cùng phát triển",
    description:
      "Kết nối học viên, giảng viên và doanh nghiệp để tạo ra hành trình học bền vững.",
    icon: "03",
  },
];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-5xl text-center text-white">
          ...
          <h1 className="text-3xl font-extrabold leading-tight sm:text-4xl lg:text-5xl">
            Chúng tôi xây dựng nền tảng học tập để mọi người phát triển sự
            nghiệp bền vững
          </h1>
          <p className="mx-auto mt-5 max-w-3xl text-sm text-white/80 sm:text-base">
            BTM Learning hướng đến việc rút ngắn khoảng cách giữa kiến thức và
            công việc thực tế thông qua các khóa học chất lượng, lộ trình rõ
            ràng và trải nghiệm học tập hiện đại.
          </p>
      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-white/10 dark:bg-slate-900/60 sm:p-8">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
            Chúng tôi tin rằng việc học hiệu quả phải đi cùng tính ứng dụng cao
            và khả năng đồng hành lâu dài.
          </p>
